...
huggingface-cli download --local-dir /Volumes/AI/models/llama-3b meta-llama/Llama-3.2-3B model-00001-of-00002.safetensors model-00002-of-00002.safetensors config.json tokenizer.json
huggingface-cli download --local-dir /Volumes/AI/models/llama-1b meta-llama/Llama-3.2-1B model.safetensors config.json tokenizer.json
